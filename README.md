![CircleCI](https://circleci.com/gh/flagmeister/flagmeister.github.io.svg?style=shield)]
...
* I first built a tool to analyze all SVG flags out there: [documentation.html#FlagMeisterAnalyzeFlags](https://flagmeister.github.io/documentation.html#FlagMeisterAnalyzeFlags)

* Worked all SVG flags into one file

* rewrote all SVG with JavaScript functions generating SVG
...
* wrote a parser to convert Strings to SVG (so when you use 1 flag only 1 SVG flag is generated)

...
There is no single truth on flags. All flag sites out in the wild have errors. The most popular one [flag-icon-css](http://flag-icon-css.lip.is/) has incorrect colors. Some are missing details in flags.

* Missing self-declared states like [Transnistria](https://en.wikipedia.org/wiki/Transnistria) and [Somaliland](https://en.wikipedia.org/wiki/Somaliland)
...
* Flags of the World - +1 - https://flags.dsgn.it/ - https://github.com/cedmax/flags

* flag-icon-css - Used:8962 - **alas almost all colors are wrong** - http://flag-icon-css.lip.is/
...
AliBaba sprite is 66.8KB

https://www.apple.com/choose-country-region/

Apple individual images 176 KB

## Comparison existing SVG flags

|                                            | flag count | nl.svg | af.svg  | bo.svg | total   |
|--------------------------------------------|------------|--------|---------|--------|---------|
| https://github.com/lipis/flag-icon-css     | **257**    | 364 B  | 20.8 KB | 115 KB | **2.24 MB** |
| https://github.com/hjnilsson/country-flags | **256**    | 195 B  | 45.4 KB | 174 KB | **2.69 MB** |
|                                            |            |        |         |        |         |
...
bhBahrein:background(RED_e10011)+path(WHITE_fff,`M114 480l-146.8.2V0h146l94 
30-93 29 93 30-93 29 93 
30-93 29 93 30-93 29 93 
30-93 29 93 30-93 29 93 
30-93 29 93 30-93 29`)

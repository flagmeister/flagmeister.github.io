...
!(function () {
          ...
          "<g transform='scale(.75 1)'>;" +
            {
              ...
              n:
                "bgcolor:#fff;path:#00f,m0 0h160v120h-160z,s;use:320;use:160,120;use:480,120;use:0,240;use:320,240;use:160,360;use:480,360",
              ...
              y:
                "bgcolor:#ff0;path:#f00,m10 520l700-520,s,80,#f00;use:-110,-110;use:-220,-220;use:110,110;use:220,220",
              z:
                "bgcolor:#000;triangle:320,240,0,0,640,0,#ff0;triangle:320,240,640,480,640,0,#00f;triangle:320,240,640,480,0,480,#f00",
  ...
  let flags = {
    ...
    ag:
      "country:Antigua;bgcolor:;stripe:0,240,0;stripe:190,120,#0072c6;pathstroke:M488 191l-72-19 61-45-75 10 39-65-67 39 12-76-45 60-18-70-20 72-45-61 13 78-66-41 38 65-73-11 60 44-75 20h332,#fcd116;pathstroke:M0 60L320 480L640 60V480H-480,#ce1126", //end cty
    ...
    //sun:
    ar:
      "country:Argentina;stripes:#75aadb|#fff|#75aadb;rotate:18,<path fill='#fcbf49' stroke='#843511' d='M0 0l28 62s.5 1 1.3.9c.8-.4.3-1.5.3-1l-24-64m-1 24c-1 9 5 15 5 23-1 8 4 13 5 16 1 3-1 5-.3 6s3-2 2-7c-.7-5-4-6-3-16.3.8-10-4-13-3-22'/>;circle:320,240,20,#fcbf49", //end cty
    ...
    uy:
      "country:Uruguay;detail:80;stripes:#fff|#0038a8|#fff|#0038a8|#fff|#0038a8|#fff|#0038a8|#fff;rect:0,0,266,266,#fff;rotate:16,<path fill='#fcbf49' stroke='#843511' d='M0 0l28 62s.5 1 1.3.9c.8-.4.3-1.5.3-1l-24-64m-1 24c-1 9 5 15 5 23-1 8 4 13 5 16 1 3-1 5-.3 6s3-2 2-7c-.7-5-4-6-3-16.3.8-10-4-13-3-22'/>,130,135,1.3;circle:130,135,30,#fcd116", //end cty

    as:
      "country:American Samoa;detail:40;bgcolor:#002b7f;pathstroke:m660 10v470L30 240z,#fff,25,#ce1126", //end cty
    at: "country:Austria;stripes:#ed2939|#fff|#ed2939", //end cty

    //todo star7 fat
    au:
      "country:Australia;bgcolor:#012169;gb;path:#fff,m0 0-18 1 2 18-12-13-12 13 2-18-18-1 15-9-10-15 17 6 5-17 5 17 17-6-10 15,s;use:110,185,2;use:500,80;use:500,390;use:410,210;use:590,190;use:1050,500,.5", //end cty

    //todo star 4 points
    aw:
      "country:Aruba;bgcolor:#418fd1;pathstroke:M60 130l79-20l20-79l20 79l79 20l-79 20l-20 79l-20-79z,#ef3340,5,#fff;stripe:270,30,#ffd100;stripe:330,30,#ffd100", //end cty

    ax:
      "country:Alland_Islands;bgcolor:#0053a5;doublecross:-80,0,#ffce00,#d21034,130,50", //end cty
    ...
    ba:
      "country:Bosnia and Herzogovina;bgcolor:#002395;pathstroke:m130 0l480 480v-480,#fecb00;star:#fff,10,-20,3;use:30,0,3;use:50,20,3;use:70,40,3;use:90,60,3;use:110,80,3;use:130,100,3;use:150,120,3;use:170,140,3", //end cty
    bb:
      "country:Barbados;bars:#00267f|#ffc726|#00267f;path:#000,m320 135c-7 19-14 39-29 54 5-2 13-3 18-3v80h-22c-1 0-1-1-1-3-2-25-8-45-15-67 0-3-9-14-2-12 1 0 9 3 8 2a85 85 0 0 0-46-24c-1 0-2 1-1 2 22 35 41 75 41 124 9 0 30-5 39-5v56h10l2-157,a;<use transform='matrix(-1 0 0 1 640 0)' href='#a'/>", //end cty
    ...
    bh:
      "country:Bahrein;bgcolor:#ce1126;path:#fff,m114 480l-146 1V0h180l94 48-99 48 99 48-99 48 99 48-99 48 99 48-99 48 99 48-99 48 99", //end cty
    bi:
      "country:Burundi;bgcolor:#ce1126;pathstroke:M-70 0L710 480h70v-480h-70L-70 480,#1eb53a,70,#fff;circle:320,240,140,#fff;path:#ce1126,M350 180l-19.2.4-10 16-10-16-19-0 9-17-9-17 19-0 10-16 10 16 19.2.4-9 17zm-65 112,s,4,#1eb53a;use:-60,110;use:60,110", //end cty
    ...
    bn:
      "country:Brunei;detail:60;bgcolor:#f7e017;line:100,#fff,-50,70,690,315;line:100,#000,-50,165,690,410", //end cty

    // !todo high detaul where has it gone!!
    bo: "country:Bolivia;detail:40;stripes:#d52b1e|#f9e300|#007934", //end cty
    bq:
      "country:Bonaire;bgcolor:;triangle:0,480,640,0,640,480,#012a87;triangle:0,0,0,225,300,0,#f9d90f;circle:165,230,80,none,14,#000;rotate:6,<path fill='#dc171d' d='M30 0 0 50-30 0'/>,165,230;rotate:4,<path fill='#000' d='M20 80 0 110-20 80'/>,165,230", //end cty

    //brazil colors wikipedia:green:#009c3b yellow:#ffdf00 blue:#002776 white
    br:
      "country:Brazil;bgcolor:#009b3a;pathstroke:M20 240l300-200l300 200l-300 200,#fedf00;circle:320,240,120,#002776;path:none,m200 200q150-20 240 80,c,20,#fff;<text dx='10' dy='5' fill='green' letter-spacing='3' font-family='Arial' font-weight='bold'><textPath alignment-baseline='top' href='#c'>ORDEM E PROGRESSO</textPath></text>;path:#fff,M4 2l1 4h4l-3 2 1 4-3-2-3 2 1-4-3-2h4,s;use:220,205;use:274,247;use:220,289;use:238,275;use:256,289;use:274,317;use:310,261;use:310,303;use:292,275;use:328,275;use:301,282;use:346,191;use:382,275;use:382,289;use:400,289;use:364,303;use:364,317'/>;use:346,317", //end cty
    bs: "country:Bahamas;striangle:#00778b|#ffc72c|#00778b", //end cty

    //todo detail white dragon
    bt:
      "country:Bhutan;detail:40;bgcolor:#ffd520;triangle:0,480,640,480,640,0,#ff4e12", //end cty
    ...
    cd:
      "country:Democratic Republic of Congo;bgcolor:#007fff;star:#f7d618,5,-5,8;line:110,#f7d618,-60,480,700,0;line:75,#ce1021,-60,480,700,0", //end cty
    cf:
      "country:Central African Republic;stripes:#003082|#fff|#289728|#ffce00;bar:260,120,#d21034;star:#ffce00,5,-5,4", //end cty
    cg:
      "country:Congo;bgcolor:#009543;triangle:0,480,640,480,640,-200,#fbde4a;triangle:200,480,640,480,640,0,#dc241f", //end cty
    ...
    //starrotate 16
    ck:
      "country:Cook Islands;detail:80;gb;rotate:16,<path fill='#fff' d='m60 8l3 9h9l-7 5 3 8.7-7-5-7 5 3-9-7-5h9'/>,470,260,1.9", //end cty
    cl:
      "country:Chile;bgcolor:;bar:0,240,#0039a6;stripe:240,240,#d52b1e;star:#fff,8,0,6", //end cty
    cm: "country:Cameroon;bars:#007a5e|#ce1126|#fcd116;star:#fcd116,42,18,6", //end cty
    cn:
      "country:China;bgcolor:#de2910;star:#ffde00,5,2,6;use:140,30,2,30;use:120,75,2;use:120,35,2;use:100,-50,2,30", //end cty
    ...
    cu:
      "country:Cuba;striangle:#002a8f|#fff|#002a8f|#fff|#002a8f,#cf142b,400;star:#fff,10,22,5.5", //end cty
    ...
    eh:
      "country:Western Sahara;striangle:|#fff|#107b00,#c4111b;circle:400,240,70,#c4111b;circle:420,240,69,#fff;star:#c4111b,90,40,4", //end cty
    ...
    et:
      "country:Ethiopia;stripes:#078930|#fcdd09|#da121a;circle:320,240,130,#0f47af;rotate:5,<line stroke-width='4' stroke='#fcdd09' x1='50' y1='15' x2='100' y2='30'/>,320,240;pathstroke:m321 146-56 172 145-105h-180l145 106z,#0f47af,8,#fcdd09", //end cty
    ...
    fm:
      "country:Micronesia;bgcolor:#75b2dd;star:#fff,90,10,3;use:155,0,3,20;use:10,68,3,-20;use:145,20,3,37", //end cty
    fo:
      "country:Faroe Islands;bgcolor:;doublecross:-80,0,#0065bd,#ed2939,125,60", //end cty
    ...
    gd:
      "country:Grenada;bgcolor:#ce1126;rect:70,70,500,340,#fcd116;triangle:70,70,320,240,70,410,#007a5e;triangle:570,70,320,240,570,410,#007a5e;circle:320,240,58,#ce1126;star:#fcd116,80,0,2;use:145,0,2;use:205,0,2;use:80,200,2;use:145,200,2;use:205,200,2;use:68,40,4", //end cty

    ge:
      "country:Georgia;bgcolor:;cross:#f00,140,100,100;cross:#f00,500,100,100;cross:#f00,140,380,100;cross:#f00,500,380,100;doublecross:0,0,#f00", //end cty
    gf:
      "country:French Guiana;bgcolor:#078930;triangle:0,0,640,480,0,480,#fcdd09;star:#da121a,40,20,6", //end cty

    //path = yellow maltezer? cross
    //do not replace <path in rotate
    gg:
      "country:Guernsey;bgcolor:;doublecross:0,0,#e8112d;rotate:4,<path fill='#f9dd16' d='m-180 40 20-20h190v-40h-190l-20-20'/>", //end cty
    gh: "country:Ghana;stripes:#ce1126|#fcd116|#006b3f;star:#000,36,16,6.7", //end cty

    //todo gibraltar red castle and key detailM
    gi:
      "country:Gibraltar;detail:40;stripes:#fff|#fff|#da000c;rect:200,80,240,200,#da000c,1", //end cty

    gl:
      "country:Greenland;bgcolor:;path:#d00c33,m0 240h640v240h-640zm80 0a160 160 0 1 0 320 0 160 160 0 0 0-320 0", //end cty
    ...
    //todo detail leaves
    gq:
      "country:Equatorial Guinea;detail:60;striangle:#3e9a00|#fff|#e32118,#0073ce,180", //end cty

    gr:
      "country:Greece;stripes:#0073ce|#fff|#0073ce|#fff|#0073ce|#fff|#0073ce|#fff|#0073ce;rect:0,0,240,240,#0073ce;line:53,#fff,120,0,120,270;line:53,#fff,0,135,240,135", //end cty
    ...
    gu:
      "country:Guam;detail:60;rect:0,0,640,480,#00257c,50,#c71b36;path:#008de8,m320 110q-170 120 0 260 170-140 0-260z,k,20,#c71b36", //end cty

    gw:
      "country:Guinea Bissau;stripes:#fcd116|#009e49;bar:0,240,#ce1126;star:#000,12,24,5", //end cty
    gy:
      "country:Guyana;striangle:#009e49|#009e49,#fff,600;triangle:0,20,560,240,0,460,#fcdd09;triangle:-16,0,300,240,-16,480,#ce1126,16,#000", //end cty
    //starrotate onestar copy
    hk:
      "country:Hong Kong;bgcolor:#de2408;rotate:5,<path fill='#fff' d='M0 0s-52-22-44-80c7-28 20-46.6 43-57 11-3 22-5 33-6-3 3-5 6-7 9-2 6-1 12 3 18 4 7 7 14 7 24a37 37 0 0 1-15 34c-7 5-14 7-21 13-5 5-8 9-9 18-0 16 4 18 9 27'/><path stroke='#de2408' d='M0 0c-20-18-18-62-3-77'/><path fill='#de2408' d='M0-105l3 9h9l-7.4 5.4 2.8 8.7-7.4-5.4-7.4 5.4 2.8-8.7-7.4-5.4h9.2'/>", //end cty
    hn:
      "country:Honduras;stripes:#0073cf|#fff|#0073cf;star:#0073cf,145,100,2;use:85,80,2;use:85,120,2;use:205,80,2;use:205,120,2", //end cty
    ...
    ht:
      "country:Haiti;detail:80;stripes:#00209f|#d21034;rect:244,180,150,120,#fff", //end cty
    ...
    il:
      "country:Israel;bgcolor:;stripe:45,70,#0038b8;stripe:360,70,#0038b8;pathstroke:m320 140 100 150-200 0zm0 200-100-150 200 0z,#fff,18,#0038b8", //end cty

    //3 legs
    im:
      "country:Isle of Man;detail:80;bgcolor:#d00c27;rotate:3,<path stroke='#000' fill='#fff' d='M-40-70l-74 29c-7-13-53-29-44-2 14 8 20 31 34 29 25-15 82-24 76 0 8 42 35 25 55 13-7-21-24-68-47-69' stroke-width='2'/>", //end cty

    //todo (low) recreate spike, pouint between circles
    // starrotate 24 spikes
    in:
      "country:India;stripes:#ff9933|#fff|#138808;circle:320,240,61,none,8,#000080;circle:320,240,12,#000080;rotate:24,<circle cx='40' cy='40' r='3' fill='#000080'/><path fill='#000080' d='m0 0 2-30-2-20-2 10 2 30'/>", //end cty
    ...
    jm:
      "country:Jamaica;bgcolor:#009b3a;pathstroke:M0 0L640 480h70v-480h-70L0 480,#000,70,#fed100", //end cty

    //star7 points from australia
    jo:
      "country:Jordan;striangle:#000|#fff|#007a3d,#ce1126,380;path:#fff,m140 240-18 1 2 18-12-13-12 13 2-18-18-1 15-9-10-15 17 6 5-17 5 17 17-6-10 15", //end cty
    ...
    kn:
      "country:Saint Kitts and Nevis;bgcolor:#009e49;diagonal:#ce1126,#fcd116,#000;star:#fff,80,0,4,40;use:100,-60,4,40", //end cty
    kp:
      "country:North Korea;stripes:#024fa2|#fff|#fff|#fff|#024fa2;stripe:110,257,#ed1c27;circle:250,240,80,#fff;star:#ed1c27,30,20,6", //end cty
    kr:
    ...
    kw:
      "country:Kuwait;striangle:#007a3d|#fff|#ce1126,#000;rect:194,159,640,160,#fff", //end cty
    ky: "country:Cayman Islands;detail:40;gb", //end cty

    kz:
      "country:Kazakhstan;detail:60;bgcolor:#00afca;rotate:32,<path fill='#ffe400' d='m0 28l-95-28l95-28'/>,320,240;circle:320,240,70,#ffe400,6,#00afca;bar:40,40,#ffe400", //end cty
    la:
      "country:Laos;stripes:#ce1126|#002868|#002868|#ce1126;circle:320,240,95,#fff", //end cty

    //todo detailM green tree
    lb:
      "country:Lebanon;detail:80;stripes:#ed1c24|#fff|#fff|#ed1c24;path:#00a651,M316 122c-7 15-39 30-26 36-10 5-15 8-20 17 3 7 11-3 12 0-16 17-44 26-51 39 41 0-4 27-20 37 10 24 35-10 35 10-17 9-39 17-54 29 9 21 54-5 63-5-15 16-48 10-48 29 25 2 43-4 68-12 41 15-31 52-34 59 20-6 54-25 70-22 15 5 15 14 35 19-9-14 0-12 9-7 13 5 15 10 30 7-17-11-48-55-25-61 31 1 74 25 95 20-7-17-34-29-51-34 19-14 42 13 42-8-20-14-27-27-54-27 12-3 42 3 42-9-6-2-52-10-38-16 7 5 31 5 32 5-12-21-51-22-63-44 0-7 17 1 34 6-8-16-36-15-9-20-23-18-54-38-74-48", //end cty

    lc:
      "country:Saint Lucia;bgcolor:#6cf;triangle:175,435,320,70,465,435,#000,20,#fff;triangle:160,440,320,240,480,440,#fcd116", //end cty

    //todo detailM crown
    //todo detailL smaller crown with Qq paths
    li:
      "country:Liechtenstein;detail:80;stripes:#002b7f|#ce1126;path:#ffd83d,M140 60l16 19 17-19-17-18zm-83 78l24 54h150l27-51c-82-78-122-78-201-3", //end cty
    ...
    ly:
      "country:Libya;stripes:#e70013|#000|#000|#239e46;path:#fff,M362 198a52 52 0 1 0 0 84 60 60 0 1 1 0-84m-13 42l81-26-50 68v-84l50 68", //end cty
    ma:
      "country:Marocco;bgcolor:#c1272d;pathstroke:M320 179l-36 110 93-67H262l93 68z,none,12,#006233", //end cty
    ...
    me:
      "country:Montenegro;detail:40;bgcolor:#d3ae3b;rect:27,27,586,426,#c40308", //end cty

    mf: "country:Saint Martin;flag:fr", //end cty
    mg: "country:Madagascar;stripes:#fc3d32|#007e3a;bar:0,213", //end cty
    // starrotate:x,y,fill,scale=1,len=30,wid=4
    mh:
      "country:Marshall_Islands;bgcolor:#003893;triangle:640,0,-80,520,640,180,#dd7500;triangle:640,84,-80,530,640,180,#fff;rotate:4,<path fill='#fff' d='m0 2l-40-2l40-2'/>,150,180,3;rotate:24,<path fill='#fff' d='m0 4l-30-4l30-4'/>,150,180,3", //end cty
    mk:
      "country:North_Macedonia;bgcolor:#d20000;path:#ffe600,M0 0h96l224 231L544 0h96L0 480h96l224-231 224 231h96zm640 192v96L0 192v96zM280 0l40 206L360 0zm0 480l40-206 40 206;circle:320,240,77,#ffe600,17,#d20000", //end cty
    ...
    //todo detailM
    mp:
      "country:North Mariana Islands;detail:60;bgcolor:#0071bc;circle:320,240,180,none,40,#fff;rect:280,100,80,350,#8c8a8c,2,#000;star:#fff,24,7,9", //end cty

    mq: "country:Martinique;flag:fr", //end cty
    mr:
      "country:Mauritania;bgcolor:#006233;stripe:410,70,#c8102e;circle:320,220,150,#ffd700;circle:320,180,145,#006233;star:#ffd700,52,10,5;stripe:0,70,#c8102e", //end cty
    ...
    mv:
      "country:Maldives;bgcolor:#d21034;rect:80,80,480,320,#007e3a;circle:350,240,80,#fff;circle:380,240,80,#007e3a", //end cty

    //todo detailL better align spoke to center of rotate circle
    mw:
      "country:Malawi;bgcolor:#000;circle:320,210,130,#ce1126;rotate:80,<path fill='#ce1126' d='m125 20l60-5q6 5 0 10'/>,320,200;stripe:140,20,#000;stripe:160,160,#ce1126;stripe:320,160,#339e35", //end cty
    ...
    //starrotate 14
    my:
      "country:Malaysia;stripes:#cc0001|#fff|#cc0001|#fff|#cc0001|#fff|#cc0001|#fff|#cc0001|#fff|#cc0001|#fff|#cc0001|#fff;rect:0,0,373,274,#010066;circle:150,135,90,#fc0;circle:167,135,82,#010066;rotate:14,<path fill='#fc0' d='m0 4l-18-4l18-4'/>,237,138,3.7", //end cty

    //todo detailM book and gun
    mz:
      "country:Mozambique;detail:80;striangle:#007168|#fff|#fce100,#d21034,310,<rect x='0' y='175' width='640' height='130' fill='#000'/>;star:#fce100,3,14,7", //end cty

    //starrotate 12
    na:
      "country:Namibia;bgcolor:#003580;triangle:0,480,640,0,640,480,#009543;line:160,#fff,-60,480,700,0;line:120,#d21034,-60,480,700,0;rotate:12,<path fill='#ffce00' d='m0 5l-11-5l11-5'/>,140,120,7;circle:140,120,45,#ffce00,8,#003580", //end cty
    nc: "country:New Caledonia;flag:fr", //end cty
    ne: "country:Niger;stripes:#e05206|#fff|#0db02b;circle:320,240,70,#e05206", //end cty
    nf:
      "country:Norfolk Island;bgcolor:#007934;bar:195,250;pathstroke:M320 100l90 250h-80v50h-20v-50h-80,#007934", //end cty
    ng: "country:Nigeria;bgcolor:#008751;bar:213,213", //end cty

    //todo detailH paths with Cc curves for true circle!
    ni:
      "country:Nicaragua;detail:80;stripes:#0067c6|#fff|#0067c6;path:none,m260 240q50-140 120 0,cv;<text dx='10' fill='#c9a504' letter-spacing='.2' font-family='Arial' font-size='13'><textPath alignment-baseline='top' href='#cv'>REPUBLICA DE NICARAGUA</textPath></text>;path:none,m250 240q70 130 140 0,cv2;<text dx='10' fill='#c9a504' letter-spacing='2' font-family='Arial' font-size='13'><textPath alignment-baseline='top' href='#cv2'>- AMERICA CENTRAL -</textPath></text>;triangle:275,260,320,180,365,260,lightblue", //end cty
    ...
    //starrotate
    np:
      "country:Nepal;pathstroke:m7 474h354l-233-236h242l-363-231z,#dc143c,14,#003893;circle:95,160,62,#fff;circle:95,143,62,#dc143c;rotate:16,<path fill='#fff' d='m0 6l-18-6l18-6'/>,95,187,2;rotate:16,<path fill='#fff' d='m0 6l-24-6l24-6'/>,95,350,3", //end cty

    nr:
      "country:Nauru;bgcolor:#002b7f;stripe:215,50,#ffc61e;rotate:12,<path fill='#fff' d='m0 6l-30-6l30-6'/>,240,360,3", //end cty
    nu:
      "country:Niue;detail:80;gb:#fcd116;circle:160,120,35,#002868;star:#fcd116,95,10,1.5;use:155,60,1.5;use:95,110,1.5;use:35,60,1.5;use:47,24,2.7", //end cty

    nz:
      "country:New Zealand;gb;<g stroke='#fff' stroke-width='2'>;star:#f00,235,20,2;use:235,170,2;use:190,85,2;use:325,90,1.7;</g>", //end cty
    ...
    pa:
      "country:Panama;bgcolor:;rect:320,0,640,240,#d62918;rect:0,240,320,480,#005293;path:#005293,m210 180l-43-28-42 28 16-45-42-28 52-1 16-45 17 45h52l-42 29 16 45;path:#d62918, m517 414l-43-28-42 28 16-45-42-28 52-1 16-45 17 45h52l-42 29 16 45", //end cty

    //todo detailM circle stuff  !todo countries API does not have detail circle! ERROR
    pe:
      "country:Peru;detail:80;bars:#d91023|#fff|#d91023;circle:320,240,80,none,10,green", //end cty

    //todo detailM // !todo detail with paths and colors
    pf:
      "country:French Polynesia;detail:60;stripes:#de2010|#fff|#fff|#de2010;circle:320,240,80,orange;path:blue,M240 240 a1 1 0 0 0 160 0", //end cty

    //todo simplify bird        //savebytes
    pg:
      "country:Papua New Guinea;bgcolor:#ce1126;triangle:0,0,640,480,0,480,#000;southerncross:#fff,20,-50,1.3;path:#fcd116,M387 119c-2-6-9-8-13-6h-27l16 6c4 12 18 14 18 14-31 2-39 7-54 35-4 14-15 13 5 13-12 9 4 4 11 3-7 6 13 0 15 0-7 9 12-2 16-3 9 7 7 6 9-4 11 3 9 3 11-7 13 18 18 36 42 40-7-17 10-4 18 0 2-8 13 5 26 5 0-6-9-16 0-9-1-11-13-20 0-16l-8-13c6-2 3-4 2-9 48 8 32 61-9 55 28 14 46 1 58-22 14 31-9 49-40 53 65 9 61-38 35-77-1-11-6-12 5-9-6-10-10-20-14-31h5c-3-7-25-22-14-22-5-7-35-17-20-22-15-10-45 14-39 0-7 0-5-1-5-7 6-7 6-5-2-9 2-9 9-14-2-8 2-13 5-12-7-9 4-6 4-11 4-18-46-2-21 77-42 77", //end cty

    //todo smaller offset triangle
    ph:
      "country:Philippines;striangle:#0038a8|#ce1126,#fff,400;rotate:8,<path fill='#fcd116' d='m-25 -40-22-32h-7l26 34c-1 1-1 1-2 2l-31-35h-9v8l36 31-2 3-35-26v7l33 21'/>,140;star:#fcd116,-10,18,2,-30;use:190,35,2,20;use:-10,190,2,-5;circle:140,240,50,#fcd116", //end cty

    pk:
      "country:Pakistan;bgcolor:#01411c;bar:0,160;circle:420,240,150,#fff;circle:450,210,140,#01411c;star:#fff,110,80,3.3,-20", //end cty
    ...
    pr:
      "country:Puerto Rico;striangle:#ed0000|#fff|#ed0000|#fff|#ed0000,#0050f0,400;star:#fff,7,13,7", //end cty
    ...
    py:
      "country:Paraguay;detail:60;stripes:#d52b1e|#fff|#0038a8;circle:320,240,60,#fff,5,#000", //end cty
    qa:
      "country:Qatar;bgcolor:#8d1b3d;path:#fff,M0 0v480h158l98-27-98-27 98-27-98-27 98-27-98-27 98-27-98-27 98-27-98-27 98-27-98-27 98-27-98-27 98-27-98-27 98-27-98-27H0", //end cty
    ...
    rw:
      "country:Rwanda;stripes:#00a1de|#00a1de|#e5be01|#20603d;rotate:24,<path fill='#fad201' d='m0 5l-80-5l80-5'/>, 515, 125;circle:515,125,25,#fad201,3,#00a1de", //end cty
    ...
    sb:
      "country:Solomon Islands;bgcolor:#215b33;triangle:0,0,640,0,0,480,#0051ba;line:40,#fcd116,0,480,640,0;star:#fff,10,0,3;use:60,0,3;use:10,45,3;use:60,45,3;use:35,20,3", //end cty
    sc:
      "country:Seychelles;bgcolor:#d62828;path:#007a3d,M0 480l930-160v160H0;path:#fff,M0 480l930-320v160L0 480;path:#003f87,M0 480V0h310L0 480;path:#fcd856,M0 480L310 0h310L0 480", //end cty
    ...
    sg:
      "country:Singapore;bgcolor:;stripe:0,240,#ed2939;path:#fff,M146 40a84 84 0 0 0 1 165 86 86 0 0 1-107-59A86 86 0 0 1 99 40c16-4 31-4 47 0;star:#fff,90,20,1.7;use:60,40,1.7;use:120,40,1.7;use:70,70,1.7;use:110,70,1.7", //end cty
    ...
    sr:
      "country:Suriname;bgcolor:#377e3f;stripe:96,288,#fff;stripe:140,200,#b40a2d;star:#ecc81d,28,11,8", //end cty
    ss:
      "country:South Sudan;stripes:#000|#fff|#078930;stripe:175,125,#da121a;triangle:0,0,320,240,0,480,#0f47af;star:#fce100,10,30,5", //end cty
    st:
      "country:Sao Tome;striangle:#12ad2b|#ffce00|#ffce00|#12ad2b,#d21034,230;star:#000,58,28,5;use:92,28,5", //end cty

    //todo add green leaves in detailM
    sv:
      "country:El_Salvador;detail:60;stripes:#0f47af|#fff|#0f47af;circle:320,240,70,#fff,5,#fc0;path:#ffcc00,M320 190l50 80h-100", //end cty

    sx: "country:Sint Maarten;detail:60;striangle:#dc1016|#002688,#fff,300", //end cty
    sy:
      "country:Syria;stripes:#ce1126|#fff|#000;star:#007a3d,30,40,4;use:108,40,4", //end cty

    //todo detailH sz shield
    sz:
      "country:Swaziland;detail:40;stripes:#3e5eb9|#b10c0c|#b10c0c|#3e5eb9;stripe:88,34,#ffd900;stripe:360,34,#ffd900", //end cty
    ...
    tk:
      "country:Tokelau;bgcolor:#00247d;path:#fed100,M108 355c134-90 266-195 401-259-39 96-11 201 67 254 7-2 34 9 12 8l-480-3zm-4 6c10 27 42 8 62 13l437 6c-4-24-32-15-48-14-152-3-311-3-451-5;southerncross:#fff,30,-99", //end cty

    tl:
      "country:Timor Leste;striangle:#dc241f|#dc241f,#ffc726,500;triangle:0,0,300,240,0,480,#000;star:#fff,-10,23,6,-25", //end cty

    //todo detailM Turkemistand banner
    tm:
      "country:Turkmenistan;detail:60;bgcolor:#00843d;bar:80,100,#d22630;circle:290,90,55,#fff;circle:275,80,55,#00843d;star:#fff,325,40,.8;use:325,75,.8;use:325,110,.8;use:360,60,.8;use:290,90,.8", //end cty

    tn:
      "country:Tunisia;bgcolor:#e70013;circle:320,240,121,#fff;circle:320,240,90,#e70013;circle:340,240,75,#fff;star:#e70013,49,67,4,-20", //end cty

    to:
      "country:Tonga;bgcolor:#c10000;rect:0,0,320,220,#fff;cross:#c10000,160,110,170,50", //end cty
    tr:
      "country:Turkey;bgcolor:#e30a17;circle:240,240,120,#fff;circle:270,240,96,#e30a17;star:#fff,58,70,4,-20", //end cty
    tt:
      "country:Trinidad and Tobago;bgcolor:#da1a35;pathstroke:M0-20l500 520h140L140-20,#000,20,#fff", //end cty

    tv:
      "country:Tuvalu;detail:40;gb:#5b97b1;star:#fff40d,82,122,3;use:110,117,3;use:110,90,3;use:140,110,3;use:160,90,3;use:185,75,3;use:185,25,3;use:160,45,3;use:135,50,3", //end cty
    //starrotatestar 12
    tw:
      "country:Taiwan;bgcolor:#fe0000;rect:0,0,320,240,#000097;rotate:12,<path fill='#fff' d='m0 28l-95-28l95-28'/>,160,125;circle:160,125,50,#fff,7,#000097", //end cty
    ...
    ug:
      "country:Uganda;detail:60;stripes:#000|#fcdc04|#d90000|#000|#fcdc04|#d90000;circle:320,240,75,#fff", //end cty

    um: "country:United States minor islands;us", //end cty
    us: "country:United States of America;us", //end cty

    uz:
      "country:Uzbekistan;stripes:#0099b5|#fff|#1eb53a;circle:134,77,58,#fff;circle:154,77,58,#0099b5;star:#fff,230,10;use:270,10;use:310,10;use:190,55;use:230,55;use:270,55;use:310,55;use:150,100;use:190,100;use:230,100;use:270,100;use:310,100;stripe:160,10,#ce1126;stripe:320,10,#ce1126", //end cty

    //detail holy moly graphics
    va: "country:Vatican City;detail:40;bgcolor:;bar:0,320,#ffe000", //end cty
    vc:
      "country:Saint Vincent;bars:#0072c6|#fcd116|#fcd116|#009e60;path:#009e60,m259 180l-46 71 45 75 44-74-43-72zm122 0l-46 71 45 75 44-74-43-72zm-62 97l-46 71 45 75 44-74-43-72", //end cty
    ve:
      "country:Venezuela;stripes:#fc0|#00247d|#cf142b;rotate:16,<path fill='#fff' d='M80 8l3 9h9l-7 5 3 8.7-7-5-7 5 3-9-7-5h9'/>,320,320,1.7;stripe:320,160,#cf142b", //end cty
    ...
    za:
      "country:South Africa;striangle:#de3831|#007a4d|#002395,#007a4d,400;path:#000,M0 382V98l212 142L0 382;path:#ffb612,M0 60v38l212 142L0 382v38l267-180L0 60;path:#007a4d,M0 60V0h89l282 191h349v98H371L89 480H0v-60l267-180L0 60;path:#fff,M89 0h55l238 160h338v31H371L89 0zm0 480h55l238-160h338v-31H371L89 480", //end cty
    zm:
      "country:Zambia;detail:80;bgcolor:#198a00;rect:385,173,240,307,#de2010;rect:471,173,240,307,#000;rect:556, 173,240,307,#ef7d00", //end cty

    //todo plus detail golden bird
    zw:
      "country:Zimbabwe;detail:80;stripes:#006400|#ffd200|#d40000|#000|#d40000|#ffd200|#006400;pathstroke:M-30-30v540L340 240z,#fff,14,#000;star:#d40000,4,8,8", //end cty
    ...
    // SPECIAL FLAGS
    eu:
      "country:European Union;bgcolor:#039;star:#fc0,148,20,2;use:148,180,2;use:68,100,2;use:228,100,2;use:78,60,2;use:108,30,2;use:218,60,2;use:188,30,2;use:218,140,2;use:188,170,2;use:78,140,2;use:108,170,2", //end cty

    un:
      "country:United Nations;bgcolor:#5b92e5;lun;circles:5,320,220,20,none,3,#fff;pathstroke:M320 220l100 0M320 220l70 70M320 220l0 100M320 220l-70 70M320 220l-100 0M320 220l-70-70M320 220l0-100M320 220l70-70,#fff,3,#fff;circle:320,220,18,#5b92e5", //end cty
        ...
        customElements.define(
          ...
          class extends baseClass {
            ...
            load(load_svg = this.svg()) {
              ...
              if (stringIncludesSVG(load_svg)) fetchdata(load_svg);
        ...
        flag.innerHTML =
          ...
          [...word].map(
            (str, idx) =>
              ...
              })}' filter=light box='150 0 340 480'></flag-${
                isos[idx] || isos[0]
              }>`
          ).join``;
      } // connectedCallback

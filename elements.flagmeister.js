...
!(function () {
    ...
    let $p_path_Color_D__id_strokewidth_stroke_color_transform = (
        ...
        , strokeColor
        , transform = ""
    ) => `<path fill='${color}' id='${id}' d='${d_path}' ${$stroke_W_Color(strokewidth, strokeColor)} transform='${transform}'/>`;
    ...
    let $S_Color_X_Y_Scale___Rotate0 = (
        ...
        , scale
        , rotate
    ) => `<defs>${$p_path_Color_D__id_strokewidth_stroke_color_transform(color, 'M12 7.7l3 9h9l-7.4 5.4 2.8 8.7-7.4-5.4-7.4 5.4 2.8-8.7-7.4-5.4h9.2z', 's')}</defs>${x ? $U_use_X_Y___scale1_rot0(x, y, scale, rotate) : ""}`;

    //todo savebytes, BUT REF all flags! put x y in outside <g> so rotate is no x,y mess
    let $U_use_X_Y___scale1_rot0 = (// use:
        x
        , y
        , scale = 1
        , rotate = 0
    ...
    let flagparser = (
        ...
        let presets = {
            ...
            , bigstar: attrs => $p_path_Color_D__id_strokewidth_stroke_color_transform(
                '#000'
            ...
            , heart: attrs => $p_path_Color_D__id_strokewidth_stroke_color_transform(
                '#000'
            ...
            ) => flagparser(`<g id='c' transform='translate(${x} ${y}) scale(${scale})'>;`
    ...
    let flags = {
        ...
        //starrotate 8 
        az: "country:Azerbaijan;stripes:#00b9e4|#ed2939|#3f9c35;"
            + "circle:304,240,72,#fff;circle:320,240,60,#ed2939;"//crescent az=azerbijdjan
            + "rotate:8,<path fill='#fff' d='m0 3l-10-3l10-3'/>,370,240,3"//sun with 8 spikes
        ,//end cty
        ...
        iq: "country:Iraq;stripes:#ce1126|#fff|#000;"
            + "path:#007a3d,"
        ...
        ir: "country:Iran;detail:40;stripes:#239f40|#fff|#da0000;"
        ...
        km: "country:Comoros;detail:80;striangle:#ffc61e|#fff|#ce1126|#3a75c4,#3d8e33,340;"
        ...
        rs: "country:Serbia;detail:900;stripes:#c6363c|#0c4076|#fff;"
            ...
            + "<use href='#e' transform='matrix(-1 0 0 1 495 0)'/>;"
        ...
        sa: "country:Saudi Arabia;detail:40;bgcolor:#006c35;"
        ...
        redcrescent: "country:Red Crescent;bgcolor:;"
